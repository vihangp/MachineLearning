...
DayHourCounts$Type = ifelse((DayHourCounts$Var1 == "dimanche") | (DayHourCounts$Var1 == "samedi"), "Weekend", "Weekday")
...
DayHourCounts$Var1 = factor(DayHourCounts$Var1, ordered=TRUE, levels=c("lundi", "mardi", "mercredi", "jeudi", "vendredi", "samedi", "dimanche"))
